...
export function evaluasiGIR(B133: number, B7: number, B6: number) {
    if (B133 === 0) {
        return "Pasien tidak mendapatkan glukosa, harap evaluasi kembali";
    }

    const rendah = (
        (B7 >= 23 && B7 <= 27 && B6 === 0 && B133 < 4) ||
        (B7 >= 23 && B7 <= 27 && B6 === 1 && B133 < 5) ||
        (B7 >= 23 && B7 <= 27 && B6 === 2 && B133 < 6) ||
        (B7 >= 23 && B7 <= 27 && B6 === 3 && B133 < 7) ||
        (B7 >= 23 && B7 <= 27 && B6 === 4 && B133 < 8) ||
        (B7 >= 23 && B7 <= 27 && B6 === 5 && B133 < 9) ||
        (B7 >= 23 && B7 <= 27 && B6 >= 6 && B133 < 10) ||
        (B7 >= 28 && B7 <= 32 && B6 === 0 && B133 < 4) ||
        (B7 >= 28 && B7 <= 32 && B6 === 1 && B133 < 5) ||
        (B7 >= 28 && B7 <= 32 && B6 === 2 && B133 < 7) ||
        (B7 >= 28 && B7 <= 32 && B6 === 3 && B133 < 9) ||
        (B7 >= 28 && B7 <= 32 && B6 >= 4 && B133 < 10) ||
        (B7 >= 33 && B7 <= 36 && B6 === 0 && B133 < 4) ||
        (B7 >= 33 && B7 <= 36 && B6 === 1 && B133 < 6) ||
        (B7 >= 33 && B7 <= 36 && B6 === 2 && B133 < 7) ||
        (B7 >= 33 && B7 <= 36 && B6 >= 3 && B133 < 8)
    );
    ...
    const tinggi = (
        ...
        (B7 >= 23 && B7 <= 27 && B6 === 5 && B133 > 9) ||
        (B7 >= 23 && B7 <= 27 && B6 >= 6 && B133 > 10) ||
        (B7 >= 28 && B7 <= 32 && B6 === 0 && B133 > 5) ||
        (B7 >= 28 && B7 <= 32 && B6 === 1 && B133 > 7) ||
        (B7 >= 28 && B7 <= 32 && B6 === 2 && B133 > 9) ||
        (B7 >= 28 && B7 <= 32 && B6 >= 3 && B133 > 10) ||
        (B7 >= 33 && B7 <= 36 && B6 === 0 && B133 > 6) ||
        (B7 >= 33 && B7 <= 36 && B6 === 1 && B133 > 7) ||
        (B7 >= 33 && B7 <= 36 && B6 >= 2 && B133 > 8)
    );
